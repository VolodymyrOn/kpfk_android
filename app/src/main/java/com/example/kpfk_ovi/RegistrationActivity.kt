...
// Перевірка дозволів
            ...
            // Створюємо Intent для відкриття галереї
        ...
        // Обробник результату вибору зображення з галереї
        fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
            super.onActivityResult(requestCode, resultCode, data)

            if (requestCode == REQUEST_IMAGE_GALLERY && resultCode == Activity.RESULT_OK && data != null) {
                val selectedImageUri = data.data
                // Тепер ви можете використовувати selectedImageUri для відображення вибраного зображення в ImageView або виконання інших операцій.
            }
        }
